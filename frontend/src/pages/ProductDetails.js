      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
          ...
          <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
            <img src={"http://localhost:8080/" + activeImage} className='h-full w-full object-scale-down mix-blend-multiply' onMouseMove={handleZoomImage} onMouseLeave={handleLeaveImageZoom} />

            {/**product zoom */}
            {/* {zoomImage && (
              <div className="absolute w-[500px] h-[400px] bg-slate-200 p-1 -right-[510px] top-0 overflow-hidden lg:block">
                <div
                  className="w-full h-full scale-[2]"
                  style={{
                    backgroundImage: `url(http://localhost:8080/${activeImage})`,
                    ...
                    data?.productImage?.map((imgURL, index) => {
                      return (
                        <div className='h-20 w-20 bg-slate-200 rounded p-1' key={imgURL}>
                          <img src={"http://localhost:8080/" + imgURL} className='w-full h-full object-scale-down mix-blend-multiply cursor-pointer' onMouseEnter={() => handleMouseEnterProduct(imgURL)} onClick={() => handleMouseEnterProduct(imgURL)} />
                        </div>
                      )
                    })
                  }
